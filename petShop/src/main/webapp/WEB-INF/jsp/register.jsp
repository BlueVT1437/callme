    ...
    <div class="container">
        ...
        <form class="form-login"  action ="/login" method="post">
            ...
            <div class="login-wrap">
                ...
                <br>
                <input type="password" class="form-control" name="repass"  placeholder="Nhap lai Password">
                <br>
                <input type="password" class="form-control" name="idnew"  placeholder="ID">
                <label class="checkbox">

                    <span class="float:left" >
                        <span style="color: red; ">${tendn}</span>
                ...
                <button  type="submit" class="btn btn-theme btn-block" ><i class="fa fa-lock"></i> CREATE ACCOUNT</button>
                <hr>
