...
<body>
<form action="/admin/pets/charge" method="post">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <h5 class="centered" id="nl" name = "nameLogin">${nameLogin}</h5>
                    <br>
            ...
            <div id="chargePet">
                    ...
                    <li>
                        <input type="checkbox" id="action" value="1"/> <label>Bạn có thích Shop của mình không?</label>
                    </li>
                    <script language="javascript">
                        document.getElementById('action').onclick = function(e){
                            if (this.checked){
                                alert("Bạn vừa thích Shop xong! Thanks ban");
                            }
                            else{
                                alert("Bạn vừa bỏ thích Shop mình?? :((");
                            }
                        };
                    </script>
                </ul>
            ...
            <section class="wrapper">
                <div class="row" style="align-items: center;float: bottom">
                    ...
                    <div class="col-xs-3">
                        <!----------- PRODUCT CARD ----------------->
                        <div class="card" >
                            <a ><img class="card-img-top"   src="../../resources/static/img/bossImg/${item.idboss}.jpg"  alt="${item.idboss}" title="${item.bosscharacter}" style="height: 14em;width: 19.25em" ></a>
                            <div class="card-body">
    ...
    <script>
        console.log($("#nl").text());
        console.log($("#nl").text() == "namelogin");
        if($("#nl").text() == "namelogin")
        {
            $("#chargePet").addClass("hidden");
        }
